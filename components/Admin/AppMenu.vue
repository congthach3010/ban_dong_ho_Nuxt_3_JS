            ...
            <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li> <a class="dropdown-item" href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>Chat
                                Box</a>
                        </li>
                        <li> <a class="dropdown-item" href="app-file-manager.html"><i class="bx bx-right-arrow-alt"></i>File
                                Manager</a>
                        </li>
                        <li> <a class="dropdown-item" href="app-contact-list.html"><i
                                    class="bx bx-right-arrow-alt"></i>Contatcs</a>
                        </li>
                        <li> <a class="dropdown-item" href="app-to-do.html"><i class="bx bx-right-arrow-alt"></i>Todo
                                List</a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li> <a class="dropdown-item" href="user-profile.html"><i class="bx bx-right-arrow-alt"></i>User
                                Profile</a>
                        </li>
                        ...
                        <li> <a class="dropdown-item" href="errors-404-error.html"><i class="bx bx-right-arrow-alt"></i>404
                                Error</a>
                        </li>
                        <li> <a class="dropdown-item" href="errors-500-error.html"><i class="bx bx-right-arrow-alt"></i>500
                                Error</a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li> <a class="dropdown-item" href="form-elements.html"><i class="bx bx-right-arrow-alt"></i>Form
                                Elements</a>
                        </li>
                        <li> <a class="dropdown-item" href="form-input-group.html"><i
                                    class="bx bx-right-arrow-alt"></i>Input Groups</a>
                        </li>
                        <li> <a class="dropdown-item" href="form-layouts.html"><i class="bx bx-right-arrow-alt"></i>Forms
                                Layouts</a>
                        </li>
                        <li> <a class="dropdown-item" href="form-validations.html"><i class="bx bx-right-arrow-alt"></i>Form
                                Validation</a>
                        </li>
                        <li> <a class="dropdown-item" href="form-wizard.html"><i class="bx bx-right-arrow-alt"></i>Form
                                Wizard</a>
                        </li>
                        <li> <a class="dropdown-item" href="form-text-editor.html"><i class="bx bx-right-arrow-alt"></i>Text
                                Editor</a>
                        </li>
                        <li> <a class="dropdown-item" href="form-file-upload.html"><i class="bx bx-right-arrow-alt"></i>File
                                Upload</a>
                        </li>
