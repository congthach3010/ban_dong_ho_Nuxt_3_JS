											...
											<div class="info-items">
												<ul>
													<li class="number"><i class="fa fa-phone"></i><a
															href="tel://0123456789">+00 123 456 789</a></li>
								...
								<div class="header-middle-align">
									<div class="header-middle-align-start">
										<div class="header-logo-area">
											<a href="index.html">
												<img class="logo-main" src="/assets_client/img/logo.webp" width="131"
													height="34" alt="Logo" />
												<img class="logo-light" src="/assets_client/img/logo-light.webp" width="131"
													height="34" alt="Logo" />
											</a>
										</div>
									</div>
													...
													<li class="mega-menu-item"><a href="#/" class="mega-title">Single
														...
														<ul>
															...
															<li><a href="blog-details-left-sidebar.html">Blog Details Left
																	Sidebar</a></li>
															<li><a href="blog-details.html">Blog Details Right Sidebar</a>
															</li>
														</ul>
													</li>
												</ul>
					...
					<div class="swiper-container home-slider-container default-slider-container">
						<div class="swiper-wrapper home-slider-wrapper slider-default">
							<div class="swiper-slide">
								<div class="slider-content-area" data-bg-img="/assets_client/img/shape/1.webp">
									<div class="container">
													...
													<div class="slider-thumb">
														<div class="thumb scene">
															<span class="scene-layer" data-depth=".3"><img
																	src="/assets_client/img/slider/slider-01.webp"
														...
														<div class="shape-group mousemove">
															<div class="shape-group-one mousemove-layer" data-speed=".8"
																data-bg-img="/assets_client/img/shape/2.webp"></div>
															<div class="shape-group-two scene"><span class="scene-layer"
																	data-depth=".6"><img
																		src="/assets_client/img/shape/3.webp" width="471"
																		height="462" alt="Image-HasTech"></span>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="row justify-content-between align-items-center">
												<div class="col-sm-6 col-md-5">
													<div class="slider-content">
														<div class="content">
															<div class="title-box">
																<h2 class="title">aaaaa New Shoes</h2>
															</div>
															<div class="desc-box">
																<p class="desc">Up To 30% Off All Shoes & Products</p>
															</div>
												...
												<div class="col-sm-6 col-md-6">
													<div class="slider-thumb">
														<div class="thumb scene">
															<span class="scene-layer" data-depth=".3"><img
																	src="/assets_client/img/slider/slider-03.webp"
								...
								<div class="product-collection">
									<div class="inner-content">
										...
										<div class="product-collection-thumb"
											data-bg-img="/assets_client/img/shop/collection/1.webp"></div>
							...
							<div class="col-lg-4 col-md-6">
								...
								<div class="product-collection">
									<div class="inner-content">
										...
										<div class="product-collection-thumb"
											data-bg-img="/assets_client/img/shop/collection/2.webp"></div>
										<a class="banner-link-overlay" href="shop.html"></a>
									</div>
								</div>
								<!--== End Product Collection Item ==-->
							...
							<div class="col-lg-4 col-md-6">
								...
								<div class="product-collection">
									<div class="inner-content">
										...
										<div class="product-collection-thumb"
											data-bg-img="/assets_client/img/shop/collection/3.webp"></div>
										<a class="banner-link-overlay" href="shop.html"></a>
									</div>
								</div>
								<!--== End Product Collection Item ==-->
									...
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/1.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/2.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-action">
												<a class="btn-product-wishlist" href="shop-wishlist.html"><i
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/3.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-flag">
												<ul>
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/4.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-action">
												<a class="btn-product-wishlist" href="shop-wishlist.html"><i
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/5.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-action">
												<a class="btn-product-wishlist" href="shop-wishlist.html"><i
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/6.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-flag">
												<ul>
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/7.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-action">
												<a class="btn-product-wishlist" href="shop-wishlist.html"><i
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="product-item">
									<div class="inner-content">
										<div class="product-thumb">
											<a href="single-product.html">
												<img src="/assets_client/img/shop/8.webp" width="270" height="274"
													alt="Image-HasTech">
											</a>
											<div class="product-flag">
												<ul>
				...
				<section class="bg-color-f2 position-relative z-index-1">
					...
					<div class="bg-layer-wrap">
						<div class="bg-layer-style z-index--1 parallax" data-speed="1.05"
							data-bg-img="/assets_client/img/photos/bg1.webp"></div>
					</div>
				</section>
											...
											<div class="swiper-slide">
												...
												<div class="product-item">
													<div class="inner-content">
														<div class="product-thumb">
															<a href="single-product.html">
																<img src="/assets_client/img/shop/1.webp" width="270"
											...
											<div class="swiper-slide">
												...
												<div class="product-item">
													<div class="inner-content">
														<div class="product-thumb">
															<a href="single-product.html">
																<img src="/assets_client/img/shop/7.webp" width="270"
																	height="274" alt="Image-HasTech">
															</a>
															<div class="product-action">
																<a class="btn-product-wishlist" href="shop-wishlist.html"><i
											...
											<div class="swiper-slide">
												...
												<div class="product-item">
													<div class="inner-content">
														<div class="product-thumb">
															<a href="single-product.html">
																<img src="/assets_client/img/shop/3.webp" width="270"
																	height="274" alt="Image-HasTech">
															</a>
															<div class="product-flag">
																<ul>
											...
											<div class="swiper-slide">
												...
												<div class="product-item">
													<div class="inner-content">
														<div class="product-thumb">
															<a href="single-product.html">
																<img src="/assets_client/img/shop/4.webp" width="270"
																	height="274" alt="Image-HasTech">
															</a>
															<div class="product-action">
																<a class="btn-product-wishlist" href="shop-wishlist.html"><i
											...
											<div class="swiper-slide">
												...
												<div class="product-item">
													<div class="inner-content">
														<div class="product-thumb">
															<a href="single-product.html">
																<img src="/assets_client/img/shop/5.webp" width="270"
																	height="274" alt="Image-HasTech">
															</a>
															<div class="product-action">
																<a class="btn-product-wishlist" href="shop-wishlist.html"><i
											...
											<div class="swiper-slide">
												...
												<div class="product-item">
													<div class="inner-content">
														<div class="product-thumb">
															<a href="single-product.html">
																<img src="/assets_client/img/shop/6.webp" width="270"
																	height="274" alt="Image-HasTech">
															</a>
															<div class="product-flag">
																<ul>
						...
						<div class="row flex-md-row-reverse justify-content-between divider-wrap divider-style2">
							<div class="col-lg-6">
								<div class="divider-thumb-content">
									<div class="thumb">
										<a href="shop.html">
											<img src="/assets_client/img/shop/banner/1.webp" width="570" height="350"
												alt="Image-HasTech">
										</a>
									</div>
									<div class="content">
							...
							<div class="col-lg-6">
								<div class="divider-thumb-content">
									<div class="thumb">
										<a href="shop.html">
											<img src="/assets_client/img/shop/banner/2.webp" width="570" height="700"
												alt="Image-HasTech">
										</a>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6 col-lg-4">
								...
								<div class="post-item">
									<div class="inner-content">
										<div class="thumb">
											<a href="blog-details.html"><img src="/assets_client/img/blog/1.webp"
													width="370" height="260" alt="Image-HasTech"></a>
										</div>
										<div class="content">
											<div class="meta-post">
												<ul>
													<li class="post-date"><i class="fa fa-calendar"></i><a
															href="blog.html">27,Jun 2030</a></li>
													<li class="author-info"><i class="fa fa-user"></i><a
															href="blog.html">Oaklee Odom</a></li>
												</ul>
											</div>
											<h4 class="title"><a href="blog-details.html">Lorem ipsum dolor ametcons
													adipisicing elit sed</a></h4>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="post-item">
									<div class="inner-content">
										<div class="thumb">
											<a href="blog-details.html"><img src="/assets_client/img/blog/2.webp"
													width="370" height="260" alt="Image-HasTech"></a>
										</div>
										<div class="content">
											<div class="meta-post">
											...
											<h4 class="title"><a href="blog-details.html">Celebrity Daughter Opens About
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="post-item">
									<div class="inner-content">
										<div class="thumb">
											<a href="blog-details.html"><img src="/assets_client/img/blog/3.webp"
													width="370" height="260" alt="Image-HasTech"></a>
										</div>
										<div class="content">
											<div class="meta-post">
								...
								<div class="widget-item">
									<div class="about-widget-wrap">
										<div class="widget-logo-area">
											<a href="index.html">
												<img class="logo-main" src="/assets_client/img/logo-light.webp" width="131"
													height="34" alt="Logo" />
											</a>
										</div>
										...
										<div class="collapse-body">
											<div class="widget-contact-wrap">
												<ul>
													...
													<li><span>Phone//fax:</span> <a href="tel://0123456789">0123456789</a>
													</li>
													<li><span>Email:</span> <a
															href="mailto://demo@example.com">demo@example.com</a></li>
													<li><a target="_blank"
															href="https://www.hasthemes.com">www.example.com</a></li>
												</ul>
											</div>
										</div>
									</div>
					...
					<div class="container pt--0 pb--0">
						<div class="row">
							<div class="col-md-7 col-lg-6">
								<p class="copyright">© 2021 Shome. Made with <i class="fa fa-heart"></i> by <a
										target="_blank"
										href="https://themeforest.net/user/codecarnival/portfolio">Codecarnival.</a></p>
							</div>
							<div class="col-md-5 col-lg-6">
								<div class="payment">
									<a href="account-login.html"><img src="/assets_client/img/photos/payment-card.webp"
					...
					<div class="product-quick-view-content">
						...
						<div class="row align-items-center">
							<div class="col-lg-6 col-md-6 col-12">
								<div class="thumb">
									<img src="/assets_client/img/shop/product-single/1.webp" width="570" height="541"
										alt="Alan-Shop">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-12">
				...
				<div class="offcanvas-body">
					<ul class="aside-cart-product-list">
						<li class="product-list-item">
							...
							<a href="single-product.html">
								<img src="/assets_client/img/shop/product-mini/1.webp" width="90" height="110"
									alt="Image-HasTech">
						...
						<li class="product-list-item">
							<a href="#/" class="remove">×</a>
							<a href="single-product.html">
								<img src="/assets_client/img/shop/product-mini/2.webp" width="90" height="110"
									alt="Image-HasTech">
					...
					<a class="d-block text-end lh-1" href="shop-checkout.html"><img
							src="/assets_client/img/photos/paypal.webp" width="133" height="26" alt="Has-image"></a>
				</div>
			</div>
			<!--== End Aside Cart Menu ==-->
...
useHead({
	title: 'Home Two :: Shome - Shoes eCommerce Website Template',
	meta: [
		{
			charset: "utf-8"
		},
		...
		{
			name: "description", content: "Shome - Shoes eCommerce Website Template"
		},
		{
			name: "keywords", content: "footwear, shoes, modern, shop, store, ecommerce, responsive, e-commerce"
		},
		{
			name: "author", content: "codecarnival",
		}
	...
	link: [
		{
			rel: "shortcut icon",
			href: "/assets_client/img/favicon.ico",
			type: "image/x-icon",
		},
		...
		{ href: "/assets_client/css/bootstrap.min.css", rel: "stylesheet" },
		{ href: "/assets_client/css/font-awesome.min.css", rel: "stylesheet" },
		{ href: "/assets_client/css/pe-icon-7-stroke.css", rel: "stylesheet" },
		{ href: "/assets_client/css/swiper.min.css", rel: "stylesheet" },
		{ href: "/assets_client/css/fancybox.min.css", rel: "stylesheet" },
		{ href: "/assets_client/css/aos.min.css", rel: "stylesheet" },
		{ href: "/assets_client/css/style.css", rel: "stylesheet" },
	],
	script: [
		{ src: "/assets_client/js/modernizr.js", body: true },
		{ src: "/assets_client/js/jquery-main.js", body: true },
		{ src: "/assets_client/js/jquery-migrate.js", body: true },
		{ src: "/assets_client/js/popper.min.js", body: true },
		{ src: "/assets_client/js/bootstrap.min.js", body: true },
		{ src: "/assets_client/js/jquery-ui.min.js", body: true },
		{ src: "/assets_client/js/swiper.min.js", body: true },
		{ src: "/assets_client/js/fancybox.min.js", body: true },
		{ src: "/assets_client/js/waypoint.js", body: true },
		{ src: "/assets_client/js/parallax.min.js", body: true },
		{ src: "/assets_client/js/aos.min.js", body: true },
		{ src: "/assets_client/js/custom.js", body: true },
	],
})
</script>
